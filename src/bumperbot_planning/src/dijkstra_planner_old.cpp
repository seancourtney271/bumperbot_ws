...
{
    DijkstraPlanner_OLD::DijkstraPlanner() : Node("dijkstra_node")
    {
        ...
        map_subscriber = create_subscription<nav_msgs::msg::OccupancyGrid>("/costmap", map_qos, std::bind(&DijkstraPlanner::mapCallback, this, std::placeholders::_1));
        goal_pose_subscriber = create_subscription<geometry_msgs::msg::PoseStamped>("/goal_pose", 10, std::bind(&DijkstraPlanner::goalCallback, this, std::placeholders::_1));

        path_publisher = create_publisher<nav_msgs::msg::Path>("/dijkstra/path", 10);
        visited_map_pubilsher = create_publisher<nav_msgs::msg::OccupancyGrid>("/dijkstra/visited_map", 10);
    }
    ...
    void DijkstraPlanner::goalCallback(const geometry_msgs::msg::PoseStamped::SharedPtr pose)
    {
        ...
        try{
            tf_buffer->lookupTransform(_map->header.frame_id, "base_footprint", tf2::TimePointZero);
